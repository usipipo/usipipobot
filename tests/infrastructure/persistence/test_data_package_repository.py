...
class TestSaveNewPackage:
    ...
    @pytest.mark.asyncio
    async def test_save_new_package_calls_set_user(self, repository, mock_session, sample_data_package):
        mock_session.get.return_value = None
...
class TestGetByUser:
    ...
    @pytest.mark.asyncio
    async def test_get_by_user_returns_empty_list_on_error(self, repository, mock_session):
