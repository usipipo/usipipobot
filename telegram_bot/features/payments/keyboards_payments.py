...
class PaymentsKeyboards:
        ...
        keyboard = [
            [
                InlineKeyboardButton(
                    "💳 Depositar Fondos", callback_data="select_amount"
                ),
                InlineKeyboardButton("📊 Historial", callback_data="payment_history"),
            ],
            [
                InlineKeyboardButton(
                    "💳 Estado de Balance", callback_data="balance_status"
                ),
                InlineKeyboardButton(
                    "📊 Métodos de Pago", callback_data="payment_methods"
                ),
            ],
    ...
    def payment_methods(amount: float) -> InlineKeyboardMarkup:
        ...
        keyboard = [
            [
                InlineKeyboardButton(
                    "💳 Balance de Cuenta",
                    callback_data=f"confirm_payment_balance_{amount}",
                ),
                InlineKeyboardButton(
                    "💳 Tarjeta de Crédito",
                    callback_data=f"confirm_payment_card_{amount}",
                ),
            ],
            [
                InlineKeyboardButton(
                    "🏦 Transferencia Bancaria",
                    callback_data=f"confirm_payment_transfer_{amount}",
                ),
                InlineKeyboardButton(
                    "₿ Criptomonedas", callback_data=f"confirm_payment_crypto_{amount}"
                ),
            ],
    ...
    def confirm_payment(payment_method: str, amount: float) -> InlineKeyboardMarkup:
        ...
        keyboard = [
            [
                InlineKeyboardButton(
                    "✅ Confirmar Pago",
                    callback_data=f"process_payment_{payment_method}_{amount}",
                ),
                InlineKeyboardButton("❌ Cancelar", callback_data="payment_back"),
            ]
        ]
    ...
    def payment_success() -> InlineKeyboardMarkup:
        ...
        keyboard = [
            [
                InlineKeyboardButton(
                    "📊 Ver Historial", callback_data="payment_history"
                ),
                InlineKeyboardButton(
                    "💳 Estado de Balance", callback_data="balance_status"
                ),
    ...
    def history_filters() -> InlineKeyboardMarkup:
        ...
        keyboard = [
            [
                ...
                InlineKeyboardButton(
                    "📅 Últimos 90 días", callback_data="filter_quarter"
                ),
            ],
            [
                InlineKeyboardButton(
                    "💳 Solo Depósitos", callback_data="filter_deposits"
                ),
    ...
    def transaction_actions(transaction_id: str) -> InlineKeyboardMarkup:
        ...
        keyboard = [
            [
                InlineKeyboardButton(
                    "📋 Ver Detalles",
                    callback_data=f"transaction_details_{transaction_id}",
                ),
                InlineKeyboardButton(
                    "📄 Descargar Recibo", callback_data=f"receipt_{transaction_id}"
                ),
            ],
    ...
    def confirmation_dialog(action: str, details: dict) -> InlineKeyboardMarkup:
        ...
        if action == "deposit":
            keyboard.append(
                [
                    InlineKeyboardButton(
                        f"✅ Confirmar ${details['amount']}",
                        callback_data=f"confirm_deposit_{details['amount']}",
                    ),
                    InlineKeyboardButton("❌ Cancelar", callback_data="payment_back"),
                ]
            )
            ...
            keyboard.append(
                [
                    InlineKeyboardButton(
                        f"✅ Retirar ${details['amount']}",
                        callback_data=f"confirm_withdraw_{details['amount']}",
                    ),
                    InlineKeyboardButton("❌ Cancelar", callback_data="payment_back"),
                ]
            )
    ...
    def payment_method_selection() -> InlineKeyboardMarkup:
        ...
        keyboard = [
            [
                InlineKeyboardButton(
                    "💳 Balance de Cuenta", callback_data="payment_balance"
                ),
                InlineKeyboardButton(
                    "💳 Tarjeta de Crédito", callback_data="payment_card"
                ),
                InlineKeyboardButton(
                    "🏦 Transferencia Bancaria", callback_data="payment_transfer"
                ),
    ...
    def bank_options() -> InlineKeyboardMarkup:
        ...
        keyboard = [
            [
                ...
                InlineKeyboardButton(
                    "🏦 Banco Provincial", callback_data="bank_provincial"
                ),
            ],
            [
                InlineKeyboardButton(
                    "🏦 Banco Santander", callback_data="bank_santander"
                ),
    ...
    def receipt_options(transaction_id: str) -> InlineKeyboardMarkup:
        ...
        keyboard = [
            [
                InlineKeyboardButton(
                    "📄 Descargar PDF", callback_data=f"receipt_pdf_{transaction_id}"
                ),
                InlineKeyboardButton(
                    "📧 Enviar por Email",
                    callback_data=f"receipt_email_{transaction_id}",
                ),
                InlineKeyboardButton(
                    "📋 Guardar en Nube",
                    callback_data=f"receipt_cloud_{transaction_id}",
                ),
            ],
            [InlineKeyboardButton("🔙 Volver", callback_data="back_to_history")],
        ]
    ...
    def withdrawal_limits() -> InlineKeyboardMarkup:
        ...
        keyboard = [
            ...
            [
                InlineKeyboardButton(
                    "💳 Personalizado", callback_data="withdraw_custom"
                ),
                InlineKeyboardButton("🔙 Volver", callback_data="payment_back"),
            ],
        ]
    ...
    def subscription_plans() -> InlineKeyboardMarkup:
        ...
        keyboard = [
            [
                InlineKeyboardButton(
                    "📅 Mensual - $9.99/mes", callback_data="subscribe_monthly"
                ),
                InlineKeyboardButton(
                    "📅 Trimestral - $27.99/mes", callback_data="subscribe_quarterly"
                ),
                InlineKeyboardButton(
                    "📅 Anual - $99.99/año", callback_data="subscribe_yearly"
                ),
            ],
            [
                InlineKeyboardButton(
                    "🎁️ Personalizado", callback_data="subscribe_custom"
                ),
                InlineKeyboardButton("🔙 Volver", callback_data="payment_back"),
            ],
        ]
    ...
    def subscription_confirmation(
        plan: str, price: float, interval: str
        ...
        keyboard = [
            [
                InlineKeyboardButton(
                    f"✅ Suscribir {plan} - ${price}/{interval}",
                    callback_data=f"confirm_subscribe_{plan}_{interval}",
                ),
                InlineKeyboardButton("❌ Cancelar", callback_data="payment_back"),
            ]
        ]
