...
class DetailPattern(BaseHandler):
    ...
    async def show_details(
        ...
        action_keyboard: InlineKeyboardMarkup = None,
    ) -> None:
        """
...
class FormPattern(BaseHandler):
    ...
    async def process_form_input(
        self, update: Update, context: ContextTypes.DEFAULT_TYPE, input_text: str
    ) -> None:
        """
        ...
        self.form_data[self.current_field] = (
            validated_value if "validator" in field else input_text
        )
